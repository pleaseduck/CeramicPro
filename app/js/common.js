...
// Реализация мобильного меню
  ...
  hamburger.addEventListener("click", function() {
    ...
    document.querySelector(".navigation-panel").classList.toggle("sidebar--inactive");
    mainNav.classList.toggle("menu-opened");
    document.querySelector(".navigation-panel").classList.toggle("sidebar__mobile--static");
